...
from transformers import XLNetForQuestionAnswering, XLNetTokenizerFast, pipeline, Trainer, TrainingArguments
from transformers import DefaultDataCollator
import pandas as pd
import numpy as np

model_name = "jkgrad/xlnet-base-squadv2"
tokenizer = XLNetTokenizerFast.from_pretrained(model_name)
# model_file_name = "electra"
model_file_name = "xlnet"
lr = 3e-5
weight_decay = 0.01
epochs = 3
...
eligibility, documents, services, admission, duration = get_annotated_data([df_1, df_2, df_3])
